...
export default function LoginDialog({ onSwitchToSignup, onSwitchToForgot, onClose }: { onSwitchToSignup: () => void, onSwitchToForgot?: () => void, onClose?: () => void }) {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      // استدعاء دالة initiateGoogleAuth من lib/api
    ...
    <form onSubmit={handleLogin} className="px-6 py-12 flex flex-col items-center">
      ...
      <div className="w-full space-y-4">
        <div className="space-y-2">
          <Label htmlFor="email-login" className="text-xl font-medium">
            البريد الإلكتروني
          </Label>
          <div className="flex">
            <Input
        ...
        >
          <div className="flex items-center justify-center gap-3">
            ...
            {googleLoading ? "جارٍ التوجيه..." : "تسجيل الدخول بواسطة Google"}
          </div>
        </Button>
